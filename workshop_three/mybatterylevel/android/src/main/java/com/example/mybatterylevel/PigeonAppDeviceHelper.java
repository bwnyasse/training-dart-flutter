...
public class PigeonAppDeviceHelper {
  ...
  public interface AppDeviceHelper {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @Nullable AppDeviceHelper api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.mybatterylevel.AppDeviceHelper.getBatteryLevel", getCodec());
        if (api != null) {
